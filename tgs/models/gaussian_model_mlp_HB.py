...
import torch
import numpy as np
from tgs.utils.general_utils import (
    inverse_sigmoid,
    inverse_softplus,
    get_expon_lr_func,
    build_rotation,
...
import os
from tgs.utils.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from tgs.utils.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from tgs.utils.graphics_utils import BasicPointCloud
from tgs.utils.general_utils import strip_symmetric, build_scaling_rotation
import matplotlib.pyplot as plt


class GaussianModelMLP_HB(nn.Module):
    ...
    def __init__(self, sh_degree: int, n_neurons: int = 8):
        ...
        self._opacity_volr = nn.Parameter(torch.empty(0))
        ...
        # + ---------------------- +
        # |       New Code         |
        self._frequencies = nn.Parameter(torch.empty(0))
        self._phases = nn.Parameter(torch.empty(0))
        self._amplitudes = nn.Parameter(torch.empty(0))
        self._offsets = nn.Parameter(torch.empty(0))
